...
object DataDoaDzikir {
    ...
    val listQauliyah: ArrayList<DoaDzikir>
        get() {
    ...
    fun listDzikir(): List<DoaDzikir> {
        val dataDzikir = arrayListOf<DoaDzikir>()
    ...
    val PagiActivity: ArrayList<DoaDzikir>
        get() {
            val listData = arrayListOf<DoaDzikir>()
    ...
    val PetangActivity: ArrayList<DoaDzikir>
        get() {
            val listData = arrayListOf<DoaDzikir>()
